...
export interface IProcess {
    ...
    /**
     * InProgress - the process is in progress, it's working |              Cancelled - the process was cancelled by the user |              Finished - the process was finished succesffully |              Error - the process stopped by an error, see the ErrorMessages for detailed information |              Interrupted - the process was interrupted by an unknown event (e.g.: server restart) - under development |              Paused - the process was paused  - under development
     */
